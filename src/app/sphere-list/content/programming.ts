...
<p>- владеть одним из языков программирования: C/C#, Python, Java;</p>
<p>- уметь пользоваться соответствующими редакторами кода: Visual Studio, Intellij IDEA, PyCharm;</p>
...
<p>- обладать достаточными знаниями для работы с основными рабочими единицами кода (переменными, включая типы и ссылки, классами, массивами).</p>
...
<p>3) выводить итоговую турнирную таблицу (количество очков, побед, ничьих, проигрышей, разница забитых и пропущенных мячей);</p>
...
<td >
<p>Если программа в целом написано верно, но имеются быстро исправимые очевидные опечатки, препятствующие запуску, то при проверке возможна минимальная коррекция текста, а оценка будет снижена</p>
</td>
</tr>
<tr>
<td >
<p>Оптимальность алгоритма (выбор способа реализации улучшающих время работы или использование памяти)</p>
</td>
<td >
<p>20</p>
</td>
...
<tr>
<td >
<p>Оптимальные языковые конструкции (уместное использование сложных или, напротив простых &laquo;читабельных&raquo; синтаксических конструкций, учет побочных эффектов)</p>
</td>
<td >
<p>10</p>
</td>
...
<tr>
<td >
<p>Интерфейс и грамотность (удобство ввода данных, правильность формулировок приглашений ко вводу и пояснение при выводе)</p>
</td>
<td >
<p>15</p>
</td>
