...
<p>Организаторы чемпионата предоставляют недостающие детали для физической сборки конечного устройства.</p>
...
<p>Создание 3D-модели детали допускается в одной из перечисленных программ: TinkerCad, Autodesk Fusion 360, Blender, SketchUp Free, FreeCAD, Autodesk 3DsMax, АСКОН Компас 3D, Autodesk Inventor и др.</p>
