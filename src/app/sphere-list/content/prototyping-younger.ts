...
export class PROTOTYPING_YOUNGER {
  ...
  private static viewNameRU: string = "Прототипирование 8 класс";
  private static viewNameBE: string = "Прататыпіраванне 8 клас";
  private static viewNameEN: string = "Prototyping 8th grade";
...
<ul>
<li>выканаць замеры і намаляваць на паперы эскізы з указаннямі памераў (у колькасці дастатковай для прайгравання дэталяў у CAD-рэдактары);</li>
...
<tr style="height: 35px;">
<td style="height: 35px;">
<p>эскізы, якія даюць уяўленне аб канчатковым выглядзе вырабаў, выкананых на паперы</p>
</td>
<td style="height: 35px;">
<p>10</p>
</td>
...
<tr style="height: 35px;">
<td style="height: 35px;">
<p>памеры на эскізах адпавядаюць заданню</p>
</td>
<td style="height: 35px;">
<p>15</p>
</td>
...
<p>эскізы пабудаваны ў дастатковай колькасці для прайгравання дэталяў у CAD-рэдактары</p>
</td>
<td style="height: 35.4px;">
<p>15</p>
</td>
...
<tr style="height: 35px;">
<td style="height: 35px;">
<p>памеры 3D-мадэлі адпавядаюць памерам на&nbsp;эскізе</p>
</td>
<td style="height: 35px;">
<p>30</p>
</td>
