...
export const PROTOTYPING_YOUNGER: Sphere = {
  ...
  viewName: "Прототипирование (младшая категория)",
  ...
  content: `<h2>ПРОТОТИПИРОВАНИЕ МЛАДШАЯ КАТЕГОРИЯ</h2>
<ol>
...
<li>PLA-пластик &ndash; 1 катушка;</li>
<li>карандаши &ndash; 3 шт.,</li>
<li>и другие канцелярские принадлежности, необходимые для выполнения конкурсных заданий.</li>
</ul>
