        ...
        < ol start = "2" >
          <li>АБ СПАБОРНІЦТВАХ < /li>
            ...
            < p > На працягу конкурса ўдзельнікі распрацоўваюць сайт з дызайнам, які адпавядае прынцыпу аднастайнасці ў структуры старонкі: адзіны памер элементаў, аднолькавая вышыня навігацыйных кнопак, аднолькавае афармленне загалоўкаў, падзагалоўкаў і асноўнага тэксту, аднолькавае афармленне спасылак і выяваў для ўсіх старонак сайта.Ставіцца задача звярстаць САЙТ.< /p>
              < p > Парады не з'яўляюцца часткай задання. Выконвайце параду толькі ў той меры, у якой яны могуць вам дапамагчы.</p>
                < p > Вёрстка сайта можа выконвацца ТОЛЬКІ ў рэдактары кода.< /p>
                  < p > Пры выкананні конкурснага задання выкарыстанне інтэрнет - рэсурсаў забаронена.Нельга выкарыстоўваць вонкавыя бібліятэкі.< /p>
                    < p > Уступныя дадзеныя: падаюцца гатовыя скрыншоты, якія паказваюць, як старонкі выглядаюць пры шырыні экрана 1920, 768px.< /p>
                      < p > Кантрольная кропка адрозненняў паміж вузкім і шырокім экранам складае 800px.< /p>
                        < p > Прадстаўляюцца файлы шрыфтоў і малюнкаў старонак.Выходныя дадзеныя: файлы index.html, p1.html, p2.html, p3.html, style.css, а таксама набор іншых.неабходных для карэктнага адлюстравання старонак у браўзарах файлаў.< /p>
                          < ol start = "3" >
                              ...
                              < p > Удзельнік прывозіць самастойна: </p>
                                ...
                                <li>камп'ютар (ноўтбук) з праграмным забеспячэннем, неабходным для выканання конкурснага задання - 1 шт.;</li>
                                  < li > USB - флэш - назапашвальнік(ёмістасцю не менш за 4ГБ) - 1 шт.; </li>
                                    < li > сеткавы фільтр(з падаўжальнікам), 5 м - 1 шт.< /li>
                                      < /ul>
                                      < ol start = "4" >
                                        <li>ПАТРАБАВАННІ ДА ВЕРСТКІ < /li>
                                          < /ol>
                                          < p > 4.1.& nbsp;вёрстка валідная.Для праверкі валіднасці вёрсткі выкарыстоўвайце сэрвіс < a href = "https://validator.w3.org" > https://validator.w3.org</a></p>
<p>4.2.вёрстка семантычная < /p>
  < p > 4.3.& nbsp;пры напісанні кода рэкамендуецца прытрымлівацца гайдлайну < a href = "https://codeguide.academy/html-css.html" > https://codeguide.academy/html-css.html</a></p>
<p>4.4.кантэнт размяшчаецца ў блоку, які гарызантальна цэнтруецца на старонцы < /p>
  < p > 4.5.старонка сайта павінна карэктна адлюстроўвацца ў браўзэры Google Chrom, Firefox і Яндэкс апошняй версіі < /p>
    < p > 4.6.у footer неабходна, год стварэння прыкладання.< /p>
      < ol start = "5" >
        <li>КРЫТЭРЫІ АЦЭНКІ < /li>
          < /ol>
...
<p>5.2.Вёрстка семантычная + 20 < /p>
  < p > 5.3.У кодзе старонцы прысутнічаюць і выкарыстоўваюцца па прызначэнні наступныя элементы: </p>
    < p > Пад "выкарыстоўваюцца па прызначэнні" маецца на ўвазе, што ў элементаў ёсць нейкі змест, які адпавядае тыпу элемента, а не дададзеныя пустыя тэгі для атрымання балаў.Правільнасць выкарыстання элементаў не правяраецца і на бал не ўплывае.< /p>
      < p > 5.3.1.header, main, footer + 5 < /p>
        < p > 5.3.2.элемент nav + 5 < /p>
                ...
                < p > 5.3.6.для афармлення СV выкарыстоўваюцца css - стылі + 10 < /p>
                  < p > 5.3.7.пры памяншэнні маштабу старонкі браўзара вёрстка размяшчаецца па цэнтры па гарызанталі, а не зрушваецца ў бок + 10 < /p>
                    < p > 5.3.8.на старонцы сайта ёсць выява, прапорцыі выявы не скажоныя, у выявы ёсць атрыбут alt + 10 < /p>
                      < p > 5.3.9.рух, кантакты для сувязі і пералік навыкаў аформлены ў выглядзе спісу ul & gt; li ці ul & gt; li & gt; a + 10 < /p>
                        < p > Таксама дапушчаецца выкарыстанне нумараванага спісу ol & gt; li ці ol & gt; li & gt; a < /p>
                          < p > 5.4.Адпаведнасць CSS - афармлення: </p>
                                    ...
                                    < ol start = "6" >
                                      <li>ПАРАДАК ПРАВЯДЗЕННЯ СПАБОРНІЦТВАЎ < /li>
                                        ...
                                        < p > У час правядзення конкурсу ўдзельнік павінен ведаць і строга выконваць правілы бяспечных паводзін вучняў на конкурснай пляцоўцы.< /p>
                                          < p > За грубыя парушэнні правіла бяспечных паводзін навучэнцаў, якія прывялі да псавання абсталявання, інструмента, траўмы або стварэння аварыйнай сітуацыі, удзельнік адхіляецца ад далейшага ўдзелу ў конкурсе.Рашэнне аб адхіленні прымае галоўны суддзя.< /p>
                                            < ol start = "7" >
