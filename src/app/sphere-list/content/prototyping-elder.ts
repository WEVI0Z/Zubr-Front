...
export const PROTOTYPING_ELDER: Sphere = {
  ...
  content: `<h2>ПРОТОТИПИРОВАНИЕ 10 КЛАСС</h2>
<ol>
...
<p>В качестве примерного образца для проектирования предлагается гипоидный редуктор.</p><p>&nbsp;Внешний вид примерного проектируемого устройства (рисунок 1):</p>
